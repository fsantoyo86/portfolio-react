...
import logo from '../img/agile2.png';
import iso from '../img/logo-iso.png';
      ...
      <section class=" text-gray-700 bg-green-400 h-3/6">
        <div class="max-w-6xl mx-auto px-5 py-10 ">
          <div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            <h1 class=" title-font text-4xl font-extrabold leading-10 tracking-tight text-left sm:text-5xl sm:leading-none md:text-6xl">
              Cursos
            </h1>
          </div>
          <div class="flex flex-wrap -m-4">
            <div class="xl:w-1/3 md:w-1/2 p-4">
              <div class="border border-gray-300 text-gray-300 bg-gray-700 p-6 rounded-lg">
                <div class="w-10 h-10 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-700 mb-4">
                  <img src={logo} alt="agile" />
                </div>
            ...
            <div class="xl:w-1/3 md:w-1/2 p-4">
              <div class="border border-gray-300 text-white bg-gray-700 p-6 rounded-lg">
                <div class="w-10 h-10 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 mb-4 italic">
                  <img src={logo} alt="agile" />
                </div>
                <h2 class="text-lg  font-medium title-font mb-2">
                  Complete Agile Management with scrum + 4 extra courses (Udemy)
                </h2>
            ...
            <div class="xl:w-1/3 md:w-1/2 p-4">
              <div class="border border-gray-300 text-white bg-gray-700 p-6 rounded-lg">
                <div class="w-10 h-10 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 mb-4">
                  <img src={iso} alt="iso-31000" />
                </div>
                <h2 class="text-lg  font-medium title-font mb-2">
                  ISO 31000 Enterprise Risk Management for the proffesional
                  (Udemy)
                </h2>
                ...
                <div class="text-center mt-2 leading-none flex justify-between w-full">
                  ...
                  <span class=" inline-flex items-center leading-none text-sm">
                    ...
                    >
                      <g fill="none" fill-rule="evenodd">
                        <path fill="#D8D8D8" d="M15.6 17.667h3.5V3h-3.5z" />
                        <path fill="#D8D8D8" d="M9.2 6.583v11.08h3.5V6.583z" />
                        <path fill="#667EEA" d="M2.6 17.667h3.5v-7.334H2.6z" />
                      </g>
                    </svg>
                    Principiante
